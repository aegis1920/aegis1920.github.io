...
updated : 2019-08-21 19:39:35 +0900
tags    : 
toc     : true
public  : true
parent  : what
...
- 가끔 HTML에서 EL태그가 안 나오는 경우가 있다.
     - 프로젝트의 settings에서 ~core.xml을 가보면 jst.web facet의 버전이 2.3인 경우가 있는데 이러면 웹 모듈의 버전이 낮아서 EL태그가 안 나온다. 3.1로 맞춰주자. 
     - 그래도 안 나온다면 web.xml에서 맨 위에 xml선언 부분에서 2.3으로 고정되어있지는 않은지 확인해보자. 2.3으로 되어있다면 `<?xml version="1.0" encoding="UTF-8"?>`으로 고치자.
