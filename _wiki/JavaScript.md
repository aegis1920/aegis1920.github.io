...
updated : 2019-10-05 15:45:38 +0900
tags    : 
toc     : true
public  : true
parent  : what
...
* 자바스크립트는 단일 스레드(메인 스레드인 이벤트 루프가 싱글 스레드이기 때문), 단일 호출 스택이라서 많은 작업을 처리한다면 오랜 시간동안 응답을 멈출 수 있다. 해결하기 위한 방법으로 비동기 콜백을 제공한다.
