...
title   : "내 vimrc"
category: blog
date    : 2019-06-18 13:10:46 +0900
updated : 2019-06-18 13:12:01 +0900
---
* TOC
{:toc}
...
let g:vimwiki_list = [
    \{
    \   'path': 'C:\Users\niboh\Desktop\git\aegis1920.github.io\_wiki',
    \   'ext' : '.md',
    \   'diary_rel_path': '.',
    \},
    \{
    \   'path': 'C:\Users\niboh\Desktop\Dropbox\wiki',
    \   'ext' : '.md',
    \   'diary_rel_path': '.',
    \}
\]
...
function! NewTemplate()
    ...
    call add(l:template, 'category: blog')
    ...
    " normal 모드에서 실제로 G와 $를 눌러 거시서부터 입력받도록.
    execute 'normal! G' 
    execute 'normal! $'
